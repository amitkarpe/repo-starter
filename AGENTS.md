...
- Use proportional validation. Do not require ShellCheck by default. ShellCheck is only a gate when the repository SPEC, CI, or Amit explicitly requires it; otherwise prefer focused tests plus native syntax/runtime checks.
